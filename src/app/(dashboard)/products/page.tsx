...
export default function ProductsPage() {
    ...
    return (
        <div className="flex flex-col h-full p-2 sm:p-5 lg:p-8 gap-4">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between shrink-0 gap-3 px-2 sm:px-0">
                <div>
